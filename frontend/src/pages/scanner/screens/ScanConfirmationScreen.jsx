...
export default function ScanConfirmationScreen({ data, onConfirm, onCancel, confirming }) {
    return (
        <div className="fixed inset-0 z-30 flex flex-col bg-[#090D0A]">
            ...
            <div className="flex-1 overflow-y-auto px-5 py-6">
                <div className="mx-auto flex max-w-sm flex-col items-center">
                    <div className="flex h-20 w-20 items-center justify-center rounded-full bg-white/10 ring-2 ring-brand/30">
                    ...
                    {data.ticketType && (
                        <div className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-brand/15 px-4 py-1.5 text-sm font-bold text-brand-soft">
