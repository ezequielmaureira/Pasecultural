    ...
    return (
      <ScreenShell>
        ...
        <Card className="flex flex-col gap-3 border-brand/20">
          <p className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-brand-soft">
            <Zap className="h-3.5 w-3.5" />
            Tu enlace Fest Pass
          </p>
          <p className="truncate text-sm text-brand-soft">{window.location.host}/fest-pass/{published.slug}</p>
        ...
        <div className="mx-auto w-full max-w-xs overflow-hidden rounded-2xl border border-white/10 bg-black">
          <div className="relative aspect-[9/16] w-full bg-black/40">
            ...
            <div className="absolute inset-x-0 bottom-0 flex flex-col gap-2 p-4">
              <span className="w-fit rounded-full bg-brand/20 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-brand-soft">
              ...
              <button
                ...
                className="mt-1 flex items-center justify-center gap-1.5 rounded-full bg-brand py-2.5 text-sm font-bold text-slate-950"
              >
      ...
      {screen === "info" && (
        ...
        <Card className="flex w-full flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            />
            {general.coverImage && (
              <p className="text-center text-xs font-medium text-brand">Tocá la imagen para cambiar la foto</p>
            )}
