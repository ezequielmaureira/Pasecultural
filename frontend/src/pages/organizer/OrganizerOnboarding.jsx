...
export default function OrganizerOnboarding() {
  ...
  if (checking) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-3 bg-[#090D0A] text-slate-400">
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#090D0A] px-6 py-16">
