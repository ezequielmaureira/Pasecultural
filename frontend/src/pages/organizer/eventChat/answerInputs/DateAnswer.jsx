    ...
    <div className="flex w-full flex-col gap-3">
      <div className="flex items-center justify-center gap-2">
        <button
          ...
          className="rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-xs font-medium text-slate-200 transition-colors duration-150 hover:border-brand/60 hover:bg-brand/10 hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
        >
          Hoy
        </button>
        <button
            ...
            return (
              <button
                ...
                className={`aspect-square rounded-lg text-sm transition-colors duration-150 disabled:cursor-not-allowed ${textClass} ${
                  isToday ? "border border-brand/60" : ""
                } ${!isPast ? "hover:bg-brand/20 hover:text-white" : ""}`}
              >
                {date.getDate()}
              </button>
            );
