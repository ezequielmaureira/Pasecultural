        ...
        {!result && (
          <button
            ...
            className={`flex h-9 shrink-0 items-center gap-1.5 rounded-lg px-3 text-sm font-medium transition-all duration-200 ${
              tutorialEnabled
                ? "bg-brand text-slate-950 shadow-[0_0_16px_-4px_rgba(182,255,46,0.5)]"
                : "border border-brand/30 bg-transparent text-slate-300 hover:border-brand/50 hover:text-brand-soft"
            }`}
          >
