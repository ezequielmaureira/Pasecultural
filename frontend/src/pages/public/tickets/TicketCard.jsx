...
export default function TicketCard({ ticket, onOpen }) {
    ...
    return (
        <button
            ...
            className="group flex w-full items-stretch gap-4 overflow-hidden rounded-xl border border-white/10 bg-[#111713] p-3 text-left transition-colors duration-150 hover:border-brand/40"
        >
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-1">
                ...
                {countdown && (
                    <p
                        className={`flex items-center gap-1.5 truncate text-xs font-medium ${
                            countdown.phase === "upcoming" ? "text-brand" : "text-slate-500"
                        }`}
                    >
                ...
                <div className="mt-auto flex items-center justify-between gap-2 pt-1">
                    <span className="flex items-center gap-1.5 truncate text-xs font-medium text-brand">
