          ...
          <div className="flex flex-col gap-4 py-2">
            ...
            <div className="flex flex-col gap-2">
              {REASON_OPTIONS.map((option) => (
                <label
                  key={option.value}
                  className="flex cursor-pointer items-center gap-2.5 rounded-lg border border-white/10 bg-white/5 p-3 text-sm text-slate-200 has-[:checked]:border-brand/60 has-[:checked]:bg-brand/10"
                >
                  <input
                    type="radio"
                    name="reason"
