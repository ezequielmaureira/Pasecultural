  ...
  return (
    <div className="mb-4 flex items-center justify-between gap-3">
      ...
      {viewAllHref && (
        <Link
          to={viewAllHref}
          className="flex shrink-0 items-center gap-1 text-sm font-medium text-brand transition-colors duration-150 hover:text-brand-soft"
        >
        ...
        {TRUST_FEATURES.map(({ icon, title, subtitle }) => {
          ...
          return (
            <div key={title} className="flex items-center gap-3">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-brand/15 text-brand shadow-[0_0_14px_-4px_rgba(132,204,22,0.55)] light:shadow-[0_0_10px_-6px_rgba(132,204,22,0.3)]">
