...
// provisto una sola vez por PublicShell, existe para que esas páginas
// anuncien su identidad (slug/name/logo) cuando `branding.enabled ===
// true`. Autoridad exclusiva: el backend. Nunca localStorage/
// sessionStorage/query params.
//
// El branding es puramente decorativo (tema visual) — nunca bloquea el
// render de la página mientras se resuelve: cada página muestra su propio
// loading interno normal mientras carga, y el tema se aplica recién cuando
// `branding` llega (o se queda en el default si la Organization es FREE o
// nunca llega). Ningún estado de este Context debe usarse para decidir si
