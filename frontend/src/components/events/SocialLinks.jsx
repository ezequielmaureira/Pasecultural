        ...
        {visibleLinks.map((link, index) => {
          ...
          return (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-3 rounded-lg border border-white/10 bg-white/5 p-3 transition-colors duration-150 hover:border-brand/40 hover:bg-white/10"
            >
