    ...
    return (
        <div className="fixed inset-0 z-30 flex justify-end bg-black/60" onClick={onClose} aria-hidden>
            <div
                ...
                tabIndex={-1}
                className={`flex h-full w-full ${maxWidth} flex-col overflow-y-auto border-l border-white/10 bg-[#111713] outline-none focus-visible:ring-2 focus-visible:ring-brand/50`}
            >
