    ...
    <div className="flex flex-col gap-2">
      {rows.map((row) =>
        row.editing ? (
          <div
            key={row._key}
            className="flex flex-col gap-2 rounded-xl border border-brand/30 bg-brand/5 p-3 sm:flex-row sm:items-end"
          >
            ...
            <button
              ...
              className="flex h-10 items-center justify-center gap-1.5 rounded-lg bg-brand-hover px-3 text-sm font-medium text-slate-950 transition-colors duration-150 hover:bg-brand disabled:cursor-not-allowed disabled:opacity-50"
            >
      ...
      <button
        ...
        disabled={disabled}
        onClick={addRow}
        className="flex items-center justify-center gap-1.5 rounded-lg border border-dashed border-white/15 py-2.5 text-sm font-medium text-slate-400 transition-colors duration-150 hover:border-brand/60 hover:text-brand-soft disabled:cursor-not-allowed"
      >
