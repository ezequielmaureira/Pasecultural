...
export default function TutorialSpotlight({
  ...
  return (
    <>
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none fixed z-50 rounded-2xl border-2 border-brand/80 shadow-[0_0_0_9999px_rgba(2,4,10,0.72),0_0_26px_rgba(190,242,100,0.55)] transition-all duration-200 ease-out"
        style={{
