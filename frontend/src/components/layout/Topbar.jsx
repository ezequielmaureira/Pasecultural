    ...
    <header className="fixed inset-x-0 top-0 z-10 h-[var(--topbar-height)] border-b border-white/5 bg-[#0B1120] light:border-slate-200 light:bg-white lg:pl-[var(--sidebar-width)]">
      <div className="flex h-full items-center justify-between gap-4 px-4 sm:px-6">
        <button
          ...
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-slate-300 transition-colors duration-150 hover:bg-white/5 light:text-slate-500 light:hover:bg-slate-900/5 lg:hidden"
        >
