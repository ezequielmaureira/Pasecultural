...
// Mismo criterio visual que saleConfirmationTemplate.js: HTML con estilos
// inline (nada de CSS externo/JS) + una versión text/plain, fondo claro con
// el violeta de marca como acento para verse razonablemente igual en la
// mayor cantidad de clientes de correo posible.
...
<html lang="es">
  ...
  <body style="margin:0;padding:0;background-color:#f3f4f6;">
          ...
          <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="width:480px;max-width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;">
            ...
            <tr>
              <td style="padding:24px;font-family:Arial,Helvetica,sans-serif;text-align:center;">
                <h1 style="margin:0 0 12px;font-size:18px;color:${TEXT_DARK};">Activá tu acceso como scanner</h1>
                <p style="margin:0 0 20px;font-size:14px;color:${TEXT_DARK};line-height:1.5;">
                  Hola${greetingName ? " " + greetingName : ""}. Usá este código para activar tu acceso como scanner de
                  <strong>${escapeHtml(eventTitle)}</strong> — ${escapeHtml(gate)}.
                </p>
    ...
    const text = [
        ...
        "",
        `Hola${firstName?.trim() ? " " + firstName.trim() : ""}.`,
        `Usá este código para activar tu acceso como scanner de ${eventTitle} — ${gate}.`,
        "",
        `Código: ${code}`,
        "",
        "Este código vence en 10 minutos. Si vos no pediste este código, ignorá este correo.",
